...
const open = () => fireEvent.click(screen.getByText("Ambiguous entity"));
...
describe("the collapsed affordance", () => {
  it("reads as a link, with the warning colour on the glyph alone", () => {
    ...
    const button = screen.getByText("Ambiguous entity").closest("button")!;
  ...
  it("cannot wrap onto a second line", () => {
    ...
    expect(
      screen.getByText("Ambiguous entity").closest("button")!.className
  ...
  it("is short, with the explanation behind it", () => {
    ...
    expect(screen.getByText("Ambiguous entity")).toBeInTheDocument();
